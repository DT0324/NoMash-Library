<template>
    <div class="container">
        ...
        <div class="search-bar">
            ...
            <button @click="searchByCity">Get Weather</button>
        </div>
    </div>
...
<script>
  ...
  const apikey = "70b0b3acfdc91530d36b07b7646e21a3";
  ...
  export default {
    ...
    mounted() {
        alert("To get the weather information based on your current location, please allow the browser to access your location information.");
